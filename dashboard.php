...
<head>
 ...
 <title>مستشفى الوحدةالعلاجي التعليمي-درنة</title>
<style>
  .blue-mode .bg-fuchsia, .blue-mode .bg-maroon {
    color: #fff!important;
}
</style>
</head>
<body class="hold-transition sidebar-mini blue-mode layout-fixed layout-navbar-fixed">
<!-- Site wrapper -->
<div class="wrapper">
  <!-- Navbar -->
