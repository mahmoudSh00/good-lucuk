...
<head>
  ...
  <title>  مستشفى الوحدةالعلاجي / العيادات الخارجية OPD </title>
...
<div class="login-box">
  <div class="login-logo mb-4">
    <img src="dist/img/lo.jpg" class="img-thumbnail p-0 border rounded-circle" id="system-logo">
    <div class="text-center h2 mb-0">مستشفى الوحدةالعلاجي التعليمي /درنه</div>
  </div>
  <!-- /.login-logo -->
